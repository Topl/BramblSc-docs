...
#### Testing Procedure
The testing procedure for getBlockByDepth is [described on a separate page](brambl_query_tests/getTransactionById_test)
...
#### Testing Procedure
The testing procedure for getBlockByDepth is [described on a separate page](brambl_query_tests/getTransactionByAddressStream_test)
